...
@section("content")
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Property types
                <small>list of all property types on the platform</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{route('admin.dashboard.index')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                <li class="active"><a href="">Properties</a></li>
            </ol>
            <form action="{{route('admin.property_type.delete')}}" method="post" id="deleteForm">
                {{csrf_field()}}
                ...
                <div class="col-sm-offset-2 col-sm-8 col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a href="{{route('admin.property_type.add')}}" class="btn btn-sm btn-primary"><strong>Add new Property Type</strong></a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="propertiesTable" class="table table-bordered table-striped">
                                <caption class="text-center">All Property Types</caption>
                                <thead>
                                <tr>
                                    <th>Property Type</th>
                                    <th></th>
                                ...
                                @foreach($property_types as $property_type)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-success" href="{{route('admin.property_type.edit',['id'=>$property_type->id])}}">EDIT</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-xs btn-danger del" data-id="{{$property_type->id}}" href="#">DELETE</a>
