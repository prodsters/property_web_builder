...
@section("content")
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Currencies
                <small>list of all currencies on the platform</small>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-sm-offset-2 col-sm-8 col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a href="{{route('admin.currency.add')}}" class="btn btn-sm btn-primary"><strong>Add new Currency</strong></a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="propertiesTable" class="table table-bordered table-striped">
                                <caption class="text-center">All Currencies</caption>
                                <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Symbol</th>
                                ...
                                @foreach($currencies as $currency)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-success" href="{{route('admin.currency.edit',['id'=>$currency->id])}}">EDIT</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-xs btn-danger del" data-id="{{$currency->id}}" href="#">DELETE</a>
